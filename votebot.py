...
async def update_config_channel(ctx, channel: discord.TextChannel):
    global server_data
    # update settings and save
    server_data[str(ctx.guild.id)]['config_channel'] = channel.id
...
async def remove_config_channel(ctx):
    global server_data
    # update settings and save
    server_data[str(ctx.guild.id)]['config_channel'] = None
